  ...
  return (
    <>
      ...
      <div className="border-b-2 border-gray-700 h-72 z-10 shadow-md shadow-zinc-600">
        <h1 className="text-white fill-none blur-0 font-bold text-6xl mx-16 mt-16 mb-2 w-[50%]">Welcome To Project!!!</h1>
        <h1 className="text-white fill-none blur-0 font-bold text-6xl mx-16 w-[50%]">A Decentralized Social Media Platform</h1>
      </div>
